...
enum {
	...
	BINDER_SET_IDLE_TIMEOUT		= _IOW('b', 3, int64_t),
	BINDER_SET_MAX_THREADS		= _IOW('b', 5, uint32_t),
	BINDER_SET_IDLE_PRIORITY	= _IOW('b', 6, int32_t),
	BINDER_SET_CONTEXT_MGR		= _IOW('b', 7, int32_t),
	BINDER_THREAD_EXIT		= _IOW('b', 8, int32_t),
	...
	BINDER_ENABLE_ONEWAY_SPAM_DETECTION	= _IOW('b', 16, uint32_t),
...
// TODO: above definition may need __attribute__((packed))
// struct binder_handle_cookie {
// 	uint32_t handle;
// 	binder_uintptr_t cookie;
// } __packed;
